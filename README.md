...
<p align="center">
  UE5와 C++로 게임 시스템을 만드는 걸 좋아합니다. <br/>
  처음엔 기능부터 만들고 봤지만, 프로젝트를 거치면서 "어떻게 만들면 나중에 덜 고생할까"를 더 고민하게 됐습니다. <br/>
  데이터 중심 설계와 Python 자동화로 반복을 줄이고, 필요하면 외부 API까지 직접 붙여가며 팀의 생산성을 높이는 작업을 추구하고 있습니다
</p>
...
- 📚 **어떤 과정을 통해 왜 이렇게 만들었는가**를 설명할 수 있고 **팀의 생산성을 높이는** 개발자가 되는 것이 목표입니다.
